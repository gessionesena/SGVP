...
def home(request):
    ...
    monthly_commissions_last_12_months = metrics.get_monthly_commissions_last_12_months()
    monthly_installments_last_12_months = metrics.get_monthly_installments_last_12_months()
    monthly_payment_allocations_last_12_months = metrics.get_monthly_payment_allocations_last_12_months()
    ...
    context = {
        ...
        'monthly_commissions_last_12_months': json.dumps(monthly_commissions_last_12_months),
        'monthly_installments_last_12_months': json.dumps(monthly_installments_last_12_months),
        'monthly_payment_allocations_last_12_months': json.dumps(monthly_payment_allocations_last_12_months),
